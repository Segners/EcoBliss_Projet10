...
describe('Tests API avec authentification', () => {
    ...
    describe('Tests des produits', () => {
        ...
        it('Doit retourner la liste des produits', () => {
          ...
          .then((response) => {
            ...
            response.body.forEach((product) => {
              ...
              // Exemple de vérification de valeur
        ...
        it('Doit retourner le détail complet', () => {
          ...
          cy.request(`/products`)
            .then((response) => {
              ...
              cy.request(`/products/${testProduct.id}`)
      ...
      // Test supplémentaire de sécurité
      describe('Accès non authentifié', () => {
        it('Devrait accéder aux produits sans authentification', () => {
